...
#define COPYRIGHT_STR "2009-" STRINGIZE(COPYRIGHT_YEAR) " The Bitcoin Core Developers, 2014-" STRINGIZE(COPYRIGHT_YEAR) " The Dash Core Developers, " STRINGIZE(COPYRIGHT_YEAR) " The Sibcoin Core Developers"
